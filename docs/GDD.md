...
- **Sac et coffre** : les ressources récoltées vont dans le **sac**. À la défaite, le vainqueur emporte le sac, les objets et **l'équipement porté** (Décidé). Le **coffre du village** ne se perd jamais : on y range ses ressources, mais aussi des **armes et armures de réserve** pour se rééquiper après une défaite (Décidé).
